...
@pytest.mark.asyncio
async def test_create_token_admin_only(
...
@pytest.mark.asyncio
async def test_delete_token_admin_only(
    client: httpx.AsyncClient, admin_user, regular_user, users_storage
):
    admin, admin_token = admin_user
    user, _ = regular_user
...
@pytest.mark.asyncio
async def test_delete_token_forbidden_for_user(
