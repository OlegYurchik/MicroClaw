...
from microclaw.dto import CronTask as DtoCronTask
from microclaw.toolkits.base import BaseToolKit, tool
from microclaw.toolkits.enums import PermissionModeEnum
from microclaw.toolkits.exceptions import UserDeniedAction
from .dto import CronTask
from .settings import UserCronsSettings


class UserCronsToolKit(BaseToolKit[UserCronsSettings]):
    """Tools for managing user cron tasks."""
